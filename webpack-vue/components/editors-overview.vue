    ...
    <div class="settings">
        ...
        <div class="column">
            ...
            <div class="field">
                ...
                <div class="value">
                    <dx-switch v-model="border"></dx-switch>
                </div>
            </div>
        </div>
    </div>
    <div class="picture-container" :style="{ 'outline-style': border ? 'solid' : 'none', 'outline-color': color }">
        <div class="picture" :style="{ transform: transform }">
            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                    viewBox="0 0 370 260" :style="{ width: width + 'px', height: height + 'px'}">
                <g>
                    <path :style="{ fill: color }" d="M242.694,150.939c-0.861,0.656-1.819,0.915-2.875,0.78c-0.657-1.19-1.777-1.907-2.942-2.017
                    ...
                    <path :style="{ fill: color }" d="M322.669,187.137c-8.097,4.924-14.469,12.804-22.83,17.257c2.212-3.702,4.8-7.146,7.624-10.406
...
.settings .column .field .value .dx-switch {
    height: 36px;
}
